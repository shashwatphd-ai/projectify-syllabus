-- Migration: Atomic Project Creation to Prevent Orphaned Projects
-- Created: 2025-11-10
-- Issue: P0-1 - Projects can exist without forms/metadata if inserts fail
-- Solution: Single atomic RPC function that handles all 3 inserts in a transaction
...
-- ============================================
-- CREATE HELPER FUNCTION TO DETECT ORPHANS
-- ============================================
...
GRANT EXECUTE ON FUNCTION find_orphaned_projects TO service_role;

COMMENT ON FUNCTION find_orphaned_projects IS
'Detects projects that are missing forms or metadata (orphaned projects).
Returns list of project IDs and which components are missing.';

-- ============================================
-- CREATE CLEANUP FUNCTION FOR EXISTING ORPHANS
-- ============================================
...
GRANT EXECUTE ON FUNCTION cleanup_orphaned_projects TO service_role;
